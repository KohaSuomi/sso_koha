...
module SSOKoha
  module Patches
    module AccountControllerSSOPatch
...
unless AccountController.included_modules.include? SSOKoha::Patches::AccountControllerSSOPatch
  AccountController.send(:include, SSOKoha::Patches::AccountControllerSSOPatch)
end
